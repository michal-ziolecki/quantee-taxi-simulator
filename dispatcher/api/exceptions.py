...
class BaseHTTPException(Exception):
    ...
    This error type is registered in Flask framework and translated into correct HTTP error response
    ...
    def to_response(self) -> tuple[dict[str, str | int], int]:
        ...
        and an integer as Status Code and randomly generated ID with datetime
        """
