...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    def handle_sqlalchemy_exception(request: Request, error: SQLAlchemyError) -> JSONResponse:
        logger.error(f"Error handler caught SQLAlchemyError error: {error}")
        http_error = DBException()
